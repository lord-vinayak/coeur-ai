  ...
  return (
    <header
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${
        isScrolled ? 'bg-background/20 backdrop-blur-lg border-b border-border' : 'bg-transparent'
      }`}
    >
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        <Link href="/" className="flex items-center gap-2" aria-label="Go to homepage">
          <img src="/co-logo.jpg" className="h-12 w-12 text-primary" alt="Coeur AI Logo" />
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
              <div className="p-6">
                ...
                <nav className="mt-10 flex flex-col gap-6">
                  ...
                  <Button className="mt-4" size="lg">Request a Demo</Button>
                </nav>
              </div>
            </SheetContent>
          </Sheet>
